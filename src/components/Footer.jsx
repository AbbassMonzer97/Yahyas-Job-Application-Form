...
function SocialIcon({ href, children, label }) {
  return (
    <a
      ...
      aria-label={label}
      className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-full border border-white/70 text-white transition hover:border-white hover:bg-white/10"
    >
      {children}
    </a>
  );
        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3 sm:items-center">
            <img
              ...
              alt=""
              className="mt-0.5 h-12 w-9 object-contain"
            />
            <div>
